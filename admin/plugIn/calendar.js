...
{ 
    var date = new Date(); 
    var by = date.getFullYear()-4; //最小值 → 4 年前 
    var ey = date.getFullYear()+6; //最大值 → 6 年后 
    //初始化为中文版，1为英文版 
...
mvAry[mvAry.length] = '      <tr class="jl_time" style="display:none;">'; //时间隐藏，若需要时间将display：none;去掉即可5.23
//mvAry[mvAry.length] = '        <td name="abort" id="abort" colspan="1"></td>'; 
